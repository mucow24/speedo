...
- [ ] **ARCHITECTURE.md is still accurate** for the code as it exists after
      this PR (updated in this PR if it wasn't). Required — see the note at
...
- [ ] `pytest` passes offline and `ruff check .` is clean.
